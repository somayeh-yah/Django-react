...
const sections = [
  {
    ...
    count: 3,
    lectures: [
      { id: 1, title: "Introduction", duration: "3m 9s", locked: false },
      {
        id: 2,
...
const notes = [
  {
    ...
    title: "What is Digital Marketing",
    content:
      "Arranging rapturous did believe him all had supported. Supposing so be resolving breakfast am or perfectly.",
  },
];
            ...
            <div className="p-5">
              ...
              {activeTab === 0 && (
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted mb-4">25% completed</p>
              ...
              {activeTab === 1 && (
                <div>
                  <div className="flex justify-between items-center mb-4">
                    <h4 className="font-semibold text-body">All Notes</h4>
                    <button
                      onClick={() => setNoteModal(true)}
                      className="btn-primary"
                    >
                      Add Note <i className="fas fa-pen ml-1" />
                    </button>
                  </div>
