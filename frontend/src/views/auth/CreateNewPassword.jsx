...
const inputClass = "w-full border border-br rounded-lg px-3 py-2.5 bg-background text-body placeholder:text-muted text-sm focus:outline-none focus:ring-2 focus:ring-slate-300 transition-colors";
      ...
      <section className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4 py-16">
        <div className="w-full max-w-md">
          <div className="bg-surface rounded-xl shadow-md">
            <div className="p-8">
              <div className="mb-6">
                <h1 className="text-2xl font-bold text-body mb-1">Create New Password</h1>
