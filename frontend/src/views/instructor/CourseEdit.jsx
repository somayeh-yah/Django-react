            ...
            <div className="col-span-12 md:col-span-8 lg:col-span-9">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between bg-bt-strong rounded-xl py-6 px-8 mb-6">
                <div className="mb-4 lg:mb-0">
                  <h1 className="text-white text-2xl font-bold mb-1">Update Course</h1>
                  <p className="mb-0 text-white/80 text-sm font-semibold">Learn React.Js 2024</p>
                </div>
                ...
                <div className="p-6">
                  <div className="border border-br p-4 rounded-xl mb-3 bg-gray-50 dark:bg-background">
                    ...
                    <div className="border border-br mb-2 mt-2 shadow p-3 rounded-xl">
                      ...
                      <input type="file" className={`${inputCls} mt-2`} />
                      <button
                        type="button"
              ...
              >
                Save Changes <i className="fas fa-check-circle ml-2" />
              </button>
            </div>
          </div>
        </div>
